...
echo "===================================================="
echo "Deployment complete. Your Django site should be fully live!"
echo "Render default domain: https://$RENDER_SERVICE_NAME.onrender.com"
echo "Custom domain: https://$CUSTOM_DOMAIN (apex redirects automatically)"
echo "===================================================="
