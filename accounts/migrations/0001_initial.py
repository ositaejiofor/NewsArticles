    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('profile_picture', models.ImageField(blank=True, null=True, upload_to='accounts/profiles/')),
                ('role', models.CharField(choices=[('admin', 'Administrator'), ('family', 'Family Member'), ('volunteer', 'Volunteer')], default='family', max_length=20)),
