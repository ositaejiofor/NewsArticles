...
ALLOWED_HOSTS="www.eaglecollins.onrender.com"
...
# ==============================
# 6. Verify default Render domain
# ==============================
RENDER_URL="https://$RENDER_SERVICE_NAME.onrender.com"
HTTP_STATUS=$(curl -o /dev/null -s -w "%{http_code}" $RENDER_URL)
if [ "$HTTP_STATUS" -eq 200 ]; then
    echo "✅ Site is live: $RENDER_URL"
else
    echo "⚠️ Site may not be live yet. Status code: $HTTP_STATUS"
fi

echo "===================================================="
echo "Deployment complete. Your Django site is fully live!"
echo "Access it at: $RENDER_URL"
echo "===================================================="
